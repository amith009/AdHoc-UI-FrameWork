define(['app'], function(app) {
  app.directive('currentWeather', function($http) {
    return {
            restrict: 'A',
            replace: true,            
            scope: { 
            ...
            templateUrl: 'directive/template/current-weather.html',
            link:function(scope, element, attrs){ 
                        ...
                        if (meteogram.resolution > 36e5 || i % 2 === 0) {
                            ...
                            if (sprite) {
                                ...
                                chart.renderer.image(
                                    'img/meteogram-symbols-30px.png',
                                    -sprite.x,
                                    -sprite.y,
                                    90,
                                    570
                ...
                Meteogram.prototype.getTitle = function () {
                    return this.xml.location.name + ', ' + this.xml.location.country +'<br /><b>Last update:</b>'+this.xml.meta.lastupdate+'<b> Next Update:</b>'+this.xml.meta.nextupdate;
                };
                /**
                ...
                scope.$watch('scope.state', function() {
                    var url = 'https://www.yr.no/place/India/'+scope.state+'/'+scope.city+'/forecast_hour_by_hour.xml'
                    $http.jsonp('https://www.highcharts.com/samples/data/jsonp.php?url=' + url+'&callback=JSON_CALLBACK').success(function(xml) {                    
